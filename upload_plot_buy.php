...
<head>
    ...
    <title>Upload Plot for Buy - RealEstiMate</title>
...
<div class="upload-container">
    <form action="upload_plot_rent.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="error" id="sizeError"><?php echo isset($errorMessages) ? implode('<br>', $errorMessages) : ''; ?></div> <!-- Display error messages -->
        </div>

        <div class="form-group">
            <label for="price">Price:</label>
            <input type="number" id="price" name="price" step="0.01" value="<?php echo htmlspecialchars($price); ?>" required>
            <div class="error" id="priceError"><?php echo isset($errorMessages) ? implode('<br>', $errorMessages) : ''; ?></div> <!-- Display error messages -->
        </div>
