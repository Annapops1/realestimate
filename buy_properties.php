...
$conn = new mysqli('127.0.0.1', 'root', '', 'miniproj'); // Ensure the database name matches
...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT * FROM properties WHERE transaction_type = 'buy'";
    if ($location) {
...
<head>
    ...
    <title>Buy a Property - RealEstimate</title>
